...
const PhotoItem = ({ info }) => {
  return (
    <div className=' relative cursor-pointer h-[300px] group'>
      ...
      <button className='py-3 px-6 text-sm font-medium bg-white rounded-lg text-black absolute bottom-5 left-2/4 -translate-x-2/4 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all'>Add to cart</button>
    </div>
  );
};
PhotoItem.propTypes = {
