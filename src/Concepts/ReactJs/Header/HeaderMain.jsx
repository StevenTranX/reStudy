    ...
    <div className='flex p-4 shadow-md items-center justify-center bg-wite'>
      ...
      <div className='ml-auto mr-5 flex items-center gap-5'>
        <span className='relative w-8'>
          ...
          <span className='w-5 h-5 rounded-full flex items-center justify-center bg-pink-600 text-sx absolute right-0 top-0 translate-x-2/4 text-white'>
            {cartItemsCount}
          </span>
        </span>
        <span className='relative w-8'>
      ...
      <button
        className='p-2 rounded-mg bg-gray-300 ml-auto'
        onClick={() => {
          setUser(null);
        }}
      >
